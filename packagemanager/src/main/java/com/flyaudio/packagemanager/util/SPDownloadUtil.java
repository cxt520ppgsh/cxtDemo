package com.flyaudio.packagemanager.util;
        ...
        if (mSharedPreferences == null || instance == null) {
            synchronized (SPDownloadUtil.class) {
                if (mSharedPreferences == null || instance == null) {
                    ...
                    mSharedPreferences = BaseApplication.instance().getSharedPreferences(BaseApplication.instance().getPackageName() + ".downloadSp", Context.MODE_PRIVATE);
                }
            }
        }
        return instance;
