...
public final class ToastManager {
    ...
    public static void showToast(CharSequence toastText, int duration) {
        cancelExistToast();
        Toast toast = Toast.makeText(MainApplication.instance(), toastText, duration);
        toast.show();
        wToast = new WeakReference<>(toast);
    }

    public static void showToast(@StringRes int stringResId, int duration) {
        showToast(MainApplication.instance().getString(stringResId), duration);
    }
    ...
    public static void showCenterToast(@StringRes int stringResId, int duration) {
        showCenterToast(MainApplication.instance().getString(stringResId), duration);
    }
    ...
    public static void showCenterToast(String toast, int duration) {
        View v = View.inflate(MainApplication.instance(), R.layout.toast_center_layout, null);
