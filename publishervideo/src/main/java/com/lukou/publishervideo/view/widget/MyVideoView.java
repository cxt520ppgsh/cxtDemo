...
public class MyVideoView extends StandardGSYVideoPlayer implements MyVideoViewController {
    ...
    public void setListener(){
        findViewById(R.id.last20Per).setOnClickListener(view -> seekto(-0.2f));
        findViewById(R.id.next20Per).setOnClickListener(view -> seekto(+0.2f));
        findViewById(R.id.replay).setOnClickListener(view -> replay());
    }
